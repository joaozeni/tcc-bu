...
facilidade e bom desempenho das ferramentas da mesma para a comunicação dos nós distribuidos.
...
Neste capítulo são descritos os fundamentos necessários para acompreensão do trabalho 
...
a uma sentença lógica. Como dito anteriormente aara este trabalho notam-se os operadores 
...
que o permite ignorar alguns passos, para em teorias geradas aleatóriamente 
...
multiplos \textit{SAT solver} em paralelo. A seguir é apresentado o particionamento do 
