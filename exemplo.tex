...
do problema de satisfazibilidade booleana (SAT). O problema da satisfazibilidade booleana(SAT)\cite{Biere} 
...
Este trabalho é divido em outros cinco capítulos, conforme segue.
...
\begin{figure}[!htb]
    ...
    \caption{Arvore de decisão do DPLL\cite{Katajainen}}
    \label{fig:DPLL}
\end{figure}
...
Uma delas é a taxonomia de Flynn \cite{Flynn1972}, apresentada na Tabela \ref{tab:flynn}, 
que divide as arquiteturas paralelas em relação aos seus dados e processos, hoje grande parte 
dos sistemas são MIMD. 
...
Neste trabalho foi possível compreender as diversas técnicas de computação, o problema SAT e as relações 
